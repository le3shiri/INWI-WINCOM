...
<head>
    ...
    <title>Orders - Wincom Admin</title>
    ...
    <main class="admin-main">
        ...
        <div class="admin-content">
            ...
            <div class="welcome-card">
                <h2>Orders Management Coming Soon 📦</h2>
                <p>This section will display all customer orders once the database is implemented. You'll be able to view, manage, and track orders from this page.</p>
